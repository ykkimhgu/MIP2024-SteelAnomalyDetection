...
if __name__=="__main__":
    ...
    parser.add_argument('--obj_id', action='store', type=int, required=False, default=0)
    ...
    parser.add_argument('--epochs', action='store', type=int, required=False, default=1500)
    parser.add_argument('--gpu_id', action='store', type=int, default=0, required=False)
    parser.add_argument('--data_path', action='store', type=str, required=False, default="../Datasets/Severstal/")
    parser.add_argument('--anomaly_source_path', action='store', type=str, required=False, default="../Datasets/dtd/images/crosshatched/")
...
# Hyper - Parameter 튜닝: SSIM LOSS내 window size 수정 (11 --> 30)